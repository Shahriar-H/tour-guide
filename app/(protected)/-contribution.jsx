...
// const options = {
//   upload_preset: 'npzzdrdsnjjjjjjjjjjjj',
//   unsigned: true,
// }
...
const Contribution = () => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      setisUploading(true)
      const imageUped = imageUpload(result.assets[0].uri).then((res)=>{
  ...
  return (
    <ScrollView className={  ` bg-black`}>
      ...
      {/* PlaceCard */}
      <View className="p-2">
        <Text className='text-gray-400'>My Places</Text>
        {
