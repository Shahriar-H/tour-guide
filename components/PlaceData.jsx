...
const PlaceData = ({district,placeType,searchword,profile,refreshDataFun}) => {
...
//   }, []);
  ...
  const getMyplaces = ()=>{
    ...
    fetch(api_URl+"/get-item",{
        ...
        body: JSON.stringify({query:{district:district,placeType:placeType,positive:profile?undefined:"Yes"},table:"places"})
    })
    .then((res)=>res.json())
    .then((result)=>{
        console.log(result);
